...
class BurgerMachine:
    ...
    patties = [Patty(name="Turkey", quantity=10, cost=1), Patty(name="Veggie", quantity=10, cost=1), Patty(name="Beef", quantity=15, cost=1)]
    ...
    # My UCID is ar2565 and date is 23/03/2023 
        ...
        if total == str(expected):
            ...
            self.total_sales += self.x # only if successful
    ...
    # My UCID is ar2565 and date is 23/03/2023 
      price = 0
      for burger_layers in self.inprogress_burger:
          price += burger_layers.cost
      return f"${price:.2f}"
    ...
    def run(self):
        ...
        # UCID is ar2565 and date is  23/03/2023 
          if self.currently_selecting == STAGE.Bun:
            print(self.currently_selecting._name_)
          if self.currently_selecting == STAGE.Patty:
            print(self.currently_selecting._name_)
          if self.currently_selecting == STAGE.Toppings:
            print(self.currently_selecting._name_)
